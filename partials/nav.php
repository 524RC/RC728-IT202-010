...
<nav>
    <ul>
        <?php if (is_logged_in()) : ?>
            ...
            <li><a href="<?php get_url('testApi.php', true); ?>">Search Anime</a></li>
            <li><a href="<?php get_url('list_anime.php', true); ?>">Anime List</a></li>
        <?php endif; ?>
        <?php if (!is_logged_in()) : ?>
        ...
        <?php if (has_role("Admin")) : ?>
            ...
            <li><a href="<?php get_url('admin/create_anime.php', true); ?>">Create Anime</a></li>
